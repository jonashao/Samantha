...
import static io.realm.internal.Table.NO_MATCH;
...
public abstract class RealmBasedRecyclerViewAdapter
    ...
    public RealmBasedRecyclerViewAdapter(
        ...
        if (animateResults) {
            ...
            if (animatePrimaryColumnIndex == NO_MATCH) {
            ...
            if (animateExtraColumnName != null) {
                ...
                animateExtraIdType = realmResults.getTable().getColumnType(animatePrimaryColumnIndex);
